...
<div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 dark:from-slate-900 dark:to-blue-900 pb-16 md:pb-0">
        ...
        <Card className="dark:bg-gray-800 dark:border-gray-700">
          <CardHeader>
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              <CardTitle className="text-2xl dark:text-white">{t("myActivity")}</CardTitle>
  ...
  <div className="space-y-4">
    {isLoadingInquiries ? (
      <div className="text-center py-8">
        ...
        <p className="text-slate-500 dark:text-slate-400">{t("loadingInquiries")}</p>
      </div>
      ...
      <div className="text-center py-8">
        ...
        <h3 className="text-lg font-semibold text-slate-600 dark:text-slate-200 mb-2">{t("noInquiries")}</h3>
        <p className="text-slate-500 dark:text-slate-400">{t("inquiryPrompt")}</p>
        <Link href="/properties">
          <Button className="mt-4">{t("browseProperties")}</Button>
        </Link>
      </div>
    ) : (
      <>
                ...
                <div className="flex-1">
                  ...
                  <div className="flex flex-col md:flex-row md:items-center gap-4 text-xs text-slate-500 dark:text-slate-400">
                    <div className="flex items-center gap-1">
                      ...
                      <span>{t("inquired")} {formatDate(inquiry.createdAt)}</span>
                    </div>
                    <div className="flex items-center gap-1">
                      <span>{t("by")} {inquiry.name}</span>
                    </div>
                  </div>
                </div>
              </div>
  ...
  <div className="space-y-4">
    {isLoadingSiteVisits ? (
      <div className="text-center py-8">
        <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-blue-600 mx-auto mb-4 dark:border-blue-400"></div>
        <p className="text-slate-500 dark:text-slate-400">{t("loadingSiteVisits")}</p>
      </div>
    ) : !siteVisitsData?.data || siteVisitsData.data.length === 0 ? (
      <div className="text-center py-8">
        <Eye className="w-12 h-12 text-slate-400 dark:text-slate-500 mx-auto mb-4" />
        <h3 className="text-lg font-semibold text-slate-600 dark:text-slate-200 mb-2">{t("noSiteVisits")}</h3>
        <p className="text-slate-500 dark:text-slate-400">{t("siteVisitPrompt")}</p>
        <Link href="/properties">
          <Button className="mt-4">{t("browseProperties")}</Button>
        </Link>
      </div>
              ...
              <div className="flex flex-col md:flex-row gap-4">
                <div className="flex-1">
                  ...
                  <div className="flex flex-col md:flex-row md:items-center gap-4 text-xs text-slate-500 dark:text-slate-400">
                    ...
                    <div className="flex items-center gap-1">
                      <Clock className="w-3 h-3" />
                      <span>{t("created")} {formatDate(visit.createdAt)}</span>
                    </div>
                    <div className="flex items-center gap-1">
                      <span>{t("by")} {visit.name}</span>
                    </div>
                  </div>
                </div>
              </div>
  ...
  <div className="space-y-4">
    {isLoadingWishlist ? (
      <div className="text-center py-8">
        <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-blue-600 mx-auto mb-4 dark:border-blue-400"></div>
        <p className="text-slate-500 dark:text-slate-400">{t("loadingWishlist")}</p>
      </div>
    ) : !wishlistData?.data || wishlistData.data.length === 0 ? (
      <div className="text-center py-8">
        <Heart className="w-12 h-12 text-slate-400 dark:text-slate-500 mx-auto mb-4" />
        <h3 className="text-lg font-semibold text-slate-600 dark:text-slate-200 mb-2">{t("emptyWishlist")}</h3>
        <p className="text-slate-500 dark:text-slate-400">{t("wishlistPrompt")}</p>
        <Link href="/properties">
          <Button className="mt-4">{t("browseProperties")}</Button>
        </Link>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card className="bg-gradient-to-r from-blue-500 to-blue-600 text-white">
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-blue-100 text-sm">{t("totalReferrals")}</p>
        ...
        <Card className="bg-gradient-to-r from-green-500 to-green-600 text-white">
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-green-100 text-sm">{t("completed")}</p>
        ...
        <Card className="bg-gradient-to-r from-amber-500 to-amber-600 text-white">
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-amber-100 text-sm">{t("totalEarnings")}</p>
        ...
        <Card className="bg-gradient-to-r from-purple-500 to-purple-600 text-white">
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-purple-100 text-sm">{t("pendingEarnings")}</p>
      ...
      <CardContent className="p-6">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h3 className="text-lg font-semibold text-indigo-900 dark:text-indigo-200">
            {t("earnPerReferral")} : {formatPrice(Number.parseInt(companyDetails?.referralAmount || '0') || 0)}
          </h3>
        </div>
                ...
                <div className="flex flex-col md:flex-row gap-4">
                  <div className="flex-1">
                    ...
                    <div className="flex flex-col md:flex-row md:items-center gap-4 text-xs text-slate-500 dark:text-slate-400">
                      <div className="flex items-center gap-1">
                        <Clock className="w-3 h-3" />
                        <span>{t("referred")} {formatDate(referral.createdAt)}</span>
                      </div>
                      {referral.completedAt && (
                        <div className="flex items-center gap-1">
                          <span>{t("completed")} {formatDate(referral.completedAt)}</span>
                        </div>
                      )}
                    </div>
                  </div>
