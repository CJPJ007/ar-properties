...
<div className="min-h-screen bg-gradient-to-br from-slate-50 dark:from-slate-900 to-blue-50 dark:to-blue-900 pb-16 md:pb-0 text-slate-900 dark:text-slate-100">
  ...
  {/* Hero Section */}
  <Slider className="w-full h-[300px]" showSearch={false} page="About" />
  ...
  <section className="py-20 px-4">
    <div className="max-w-7xl mx-auto">
      ...
      >
        <h2 className="text-4xl md:text-5xl font-bold mb-4 text-slate-800 dark:text-slate-200">Our Story</h2>
  ...
  <section className="py-20 bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm">
    <div className="max-w-7xl mx-auto px-4">
      <motion.div
        ...
        transition={{ duration: 0.6, ease: "easeOut" }}
      >
        <h2 className="text-4xl md:text-5xl font-bold mb-4 text-slate-800 dark:text-slate-200">Meet Our Team</h2>
        <div className="w-24 h-1 bg-gradient-to-r from-amber-500 to-orange-500 mx-auto mb-6" />
      </motion.div>
      ...
      >
        {teamLoading ? (
          ...
          <p className="col-span-full text-center text-slate-500 dark:text-slate-400">No team members found.</p>
        )}
      </div>
    </div>
  </section>
  ...
  <section className="py-20 px-4">
    <div className="max-w-7xl mx-auto">
      <motion.div
        ...
        transition={{ duration: 0.6, ease: "easeOut" }}
      >
        <h2 className="text-4xl md:text-5xl font-bold mb-4 text-slate-800 dark:text-slate-200">Our Values</h2>
        <div className="w-24 h-1 bg-gradient-to-r from-amber-500 to-orange-500 mx-auto mb-6" />
      </motion.div>
      ...
      >
        {valuesLoading ? (
          ...
          <p className="col-span-full text-center text-slate-500 dark:text-slate-400">No values found.</p>
        )}
      </div>
    </div>
  </section>
