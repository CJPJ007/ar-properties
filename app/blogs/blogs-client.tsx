...
export default function BlogsClient({ blogsData, currentPage }: BlogsClientProps) {
  ...
  return (
<div className="min-h-screen bg-gradient-to-br from-slate-900 to-gray-900 pb-16 md:pb-0 text-white">
  <Header />
  ...
  {/* Search Section */}
  <section className="py-8 bg-gray-800/70 backdrop-blur-sm border-b border-gray-700">
      ...
      <div className="flex flex-col lg:flex-row gap-4 items-center justify-between">
        <div className="relative flex-1 max-w-md">
          ...
          <Input
            ...
            className="pl-10 h-12 bg-gray-700 border-gray-600 focus:border-blue-500 text-white placeholder-gray-400"
          />
        </div>
      ...
      {filteredBlogs.length === 0 ? (
        ...
        >
          {filteredBlogs.map((blog) => (
            <BlogCard key={blog.id} blog={blog} darkMode />
          ))}
        </motion.div>
      )}
      ...
      {totalPages > 1 && (
        <div className="flex items-center justify-center gap-2 mt-12">
          <Button
            ...
            className="flex items-center gap-2 border-gray-600 text-white hover:border-blue-500"
          >
            ← Previous
          </Button>
...
function BlogCard({ blog }: { blog: Blog }) {
  ...
  className="group"
>
  <Card className="overflow-hidden bg-gray-800 shadow-lg hover:shadow-2xl transition-all duration-500 transform-gpu">
